...
// RTUutils is bundling the send, receive and CRC functions for Modbus RTU
// communications. RTU server and client will make use of it. All functions are
// static!
class RTUutils {
public:
  ...
  static void prepareHardwareSerial(HardwareSerial &s,
                                    uint16_t bufferSize = 260) {
